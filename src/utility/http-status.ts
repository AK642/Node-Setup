...
import { ResponseStatus } from "../interface/http-status-interface";
...
export = { OkResponse, UnauthorizedResponse, BadRequestResponse, NotFoundResponse, ForbiddenResponse, UnprocessableResponse, InternalServerErrorResponse, MethodNotAllowedResponse, InvalidTokenResponse };